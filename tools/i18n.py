...
HTML = [
    ...
    ('>[Founder name]<', '>[Имя основательницы]<', '>[Ім’я засновниці]<'),
    ('<p class="founder-role">Founder</p>', '<p class="founder-role">Основательница</p>', '<p class="founder-role">Засновниця</p>'),
    ('<p>[Two or three lines about her approach to coaching and her path in rhythmic gymnastics.]</p>',
     '<p>[Две-три строки о~её подходе к~тренировкам и~пути в~художественной гимнастике]</p>',
     '<p>[Два-три рядки про її підхід до~тренувань і~шлях у~художній гімнастиці]</p>'),
